...
*### GET version 10.0 ###
*#######################
*Från Mariliis 31/8 -20
*Har lagt till:
*$ (not sameas(trsp_mode, "f_rail") and not sameas(trsp_mode, "p_rail")and not sameas(trsp_mode, "p_air_short")and not sameas(trsp_mode, "p_air_medium")and not sameas(trsp_mode, "p_air_long")and not sameas(trsp_mode, "f_air"))..
*till 4 ekvationer som hade engines.
...
engines_Q(trsp_fuel, engine_type, trsp_mode, reg,t+1)$ (not sameas(trsp_mode, "f_rail") and not sameas(trsp_mode, "p_rail")and not sameas(trsp_mode, "p_air_short")and not sameas(trsp_mode, "p_air_medium")and not sameas(trsp_mode, "p_air_long")and not sameas(trsp_mode, "f_air"))..
...
infra_Q(trsp_fuel,reg, t+1)..
    infra(trsp_fuel, reg,t+1) =E= t_step * sum(trsp_mode, infra_invest(trsp_fuel,trsp_mode,reg, t+1))
