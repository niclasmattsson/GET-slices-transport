...
engines.FX("petro", "0", "f_coast", reg,init_year) =  num_veh("f_coast", reg,init_year)+0.001;
engines.FX("petro", "0", "f_ocean", reg,init_year) =  num_veh("f_ocean", reg,init_year)+0.001 ;
